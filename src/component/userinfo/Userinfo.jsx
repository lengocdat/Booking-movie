...
class Userinfo extends Component {
    ...
    updatePassword =(values) =>{
        const datauser = {
            ...
            maLoaiNguoiDung: (values.maLoaiNguoiDung.charAt(0).toUpperCase() + values.maLoaiNguoiDung.slice(1)),
            hoTen: values.hoTen
        }
            ...
            <>
                ...
                <Formik
                    ...
                    initialValues={{
                        ...
                        maNhom: "GP08",
                        maLoaiNguoiDung: this.props.user.maLoaiNguoiDung?.charAt(0).toUpperCase()+ this.props.user.maLoaiNguoiDung?.slice(1),
                            ...
                            <div className="userinfo__right__form">
                                ...
                                <div >
                                    ...
                                    <ErrorMessage name="taiKhoan">
                                        {(msg) => <div className="alert alert-danger userinfo__right__alert">{msg}</div>}
                                    </ErrorMessage>
                                </div>
                ...
                <table className="table userinfo__right__table">
                    ...
                    <tbody colspan="1">
                        ...
                        this.state.userInfo.thongTinDatVe?.map((item, index) => (
                            <tr key={index}>
                                <th>{item.tenPhim}</th>
                                <th>{item.ngayDat.substring(11, 15) + "~" + item.ngayDat.substring(5, 9)}</th>
                                <th>{item.danhSachGhe[0].tenHeThongRap}</th>
                                <th>{item.danhSachGhe.reduce((tongghe, ghe) => tongghe + ghe.tenGhe + ", ", "")}</th>
                                <th>{item.giaVe}</th>
                            </tr>
                        )):(<tr><th className="userinfo__right__table_massage">Không có lịch sử đặt vé</th></tr>)}
    ...
    isAtive = (index) => (
        this.state.changeRender === index ? "active" : ""
    )
    render() {
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-3 userinfo__left">
                                ...
                                <p className={this.isAtive("userinfo")} onClick={() => { this.setState({ changeRender: "userinfo" }) }}>Thông Tin Tài Khoản</p>
                                <p className={this.isAtive("password")} onClick={() => { this.setState({ changeRender: "password" }) }}>Đổi Mật Khẩu</p>
                                <p className={this.isAtive("historybooking")} onClick={() => { this.setState({ changeRender: "historybooking" }) }}>Lịch Sử Đặt Vé</p>
                            </div>
